# Review Pilot Rcoket chat App
This is a Rocket.chat app to automatically assign PR requests to most suitable maintainer of an open source repository and notify and nudge him periodically on Rocket.chat channels.
